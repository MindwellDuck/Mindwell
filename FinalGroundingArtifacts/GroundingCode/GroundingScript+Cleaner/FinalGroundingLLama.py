...
# File paths
input_file = '/home/g4/Desktop/fineGrounding/diff_output.csv'
output_folder = '/home/g4/Desktop/fineGrounding'
output_file = os.path.join(output_folder, 'fine30k_grounded_dataset_LLama.csv')
...
# Dictionary of cognitive distortions and their definitions from the literature
...
# Loading find tuned LLaMA model
...
def modify_text(original_text, distortion):
    ...
    user_message = (
        ...
        f"Expand the context to make the text align with this distortion while preserving the original tone and style. DO NOT USE BIG WORDS. BE AS HUMAN AND AS CLOSE TO THE ORIGINAL AS POSSIBLE. DO NOT FIX THE ORIGINAL TEXT'S GRAMMAR.\n"
    ...
    try:
        ...
        # Use the entire generated text as the modified text, we filter later
...
# merge any previously saved data with the current run
if df_existing is not None:
