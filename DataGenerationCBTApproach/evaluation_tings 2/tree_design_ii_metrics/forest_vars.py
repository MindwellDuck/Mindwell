...
cognitive_forest: dict[str, dict[str, dict[str, str]]] = {
    "cognitive_rigidity": {
        ROOT: {
            QUESTION: "Does this thought contain definite/absolute terms?",
            YES: ALL_OR_NOTHING_THINKING_QUESTION,
            NO: NO_DISTORTION,
        },
        ALL_OR_NOTHING_THINKING_QUESTION: {
            QUESTION: "Does this thought indicate that the writer thinks there is no middle ground?",
            YES: ALL_OR_NOTHING_THINKING,
            NO: PERSONALIZATION_QUESTION,
        },
        PERSONALIZATION_QUESTION: {
            QUESTION: "Is this thought subjective to one perspective but can have other explanations?",
            YES: PERSONALIZATION,
            NO: LABELING_QUESTION,
        },
        LABELING_QUESTION: {
            QUESTION: "Does this thought indicate that the writer believes this event or action to define his traits?",
            YES: LABELING,
    ...
    "predictions_and_misinterpretations": {
        ...
        FORTUNE_TELLING_QUESTION: {
            QUESTION: "Does the thought indicate that the writer believes the worst case scenario is what's going to happen?",
            YES: FORTUNE_TELLING,
            NO: WHAT_IF_STATEMENTS_QUESTION,
        },
        WHAT_IF_STATEMENTS_QUESTION: {
            QUESTION: 'Is the thought "what if" based?',
            YES: WHAT_IF_STATEMENTS,
            NO: MIND_READING_QUESTION,
        },
        MIND_READING_QUESTION: {
            QUESTION: "Is the writer assuming knowledge of others' thoughts with zero evidence?",
            YES: MIND_READING,
    ...
    "negative_bias": {
        ROOT: {
            QUESTION: "Does this thought acknowledge more negatives than positives?",
            YES: MENTAL_FILTER_QUESTION,
            NO: "expectation_question",
        },
        "expectation_question": {
            QUESTION: "Does the thought project an expectation towards oneself or others?",
            YES: UNFAIR_COMPARISONS_QUESTION,
            NO: NO_DISTORTION,
        },
        UNFAIR_COMPARISONS_QUESTION: {
            QUESTION: "Does the thought make an unfair comparison?",
            YES: UNFAIR_COMPARISONS,
            NO: SHOULD_STATEMENTS_QUESTION,
        },
        SHOULD_STATEMENTS_QUESTION: {
            QUESTION: "Does the thought indicate that the writer feels the need to do or achieve something based on an expectation?",
            YES: SHOULD_STATEMENTS,
            NO: NO_DISTORTION,
        },
        "mental_filter_question": {
            QUESTION: "Does this thought indicate pure focus on the negatives and is the writer not acknowledging any positives?",
            YES: MENTAL_FILTER,
            NO: "negative_positives",
        },
        "negative_positives": {
            QUESTION: "Does this thought contain any positive acknowledgements?",
            YES: DISCOUNTING_THE_POSITIVE_QUESTION,
            NO: MAGNIFICATION_MINIMIZATION_QUESTION,
        },
        MAGNIFICATION_MINIMIZATION_QUESTION: {
            QUESTION: "Does the thought indicate either downplaying or exaggeration of a situation, action, or environment?",
    ...
    "responsibility": {
        ROOT: {
            QUESTION: "Is the writer placing the responsibility on solely one person?",
            YES: BLAMING,
            NO: NO_DISTORTION,
        }
    },
    "subjectivity_and_emotional_reasoning": {
        ROOT: {
            QUESTION: "Does the thought stem from emotions?",
